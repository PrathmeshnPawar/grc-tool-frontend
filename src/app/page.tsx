...
const columns: GridColDef[] = [
  {
    ...
    flex: 1,
    minWidth: 200, // From ComplianceFramework
    renderCell: (params) => (
      <Box
...
export default function Dashboard() {
  ...
  useEffect(() => {
    // Example: Aggregating counts from different endpoints
    const fetchDashboardData = async () => {
      try {
        const [risks, frameworks, audits, policies] = await Promise.all([
          api.get("/risks"),
